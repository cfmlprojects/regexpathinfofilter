...
cls
echo.
echo       regexpathinfofilter menu
REM echo       usage: regexpathinfofilter.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: regexpathinfofilter.bat stop
goto end
::
:stopServer
